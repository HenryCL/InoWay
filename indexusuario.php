// <?php
// include_once('AtualizarMarcenariaController.php');
// $AtualizarMarcenaria = new AtualizarMarcenariaController;
// if(isset($_POST['confirmar'])){
//     $AtualizarMarcenaria->Atualizar($_POST);
// }
// ?>
...
<head>
    ...
    <link rel="stylesheet" href="stylemarcenaria.css">
    ...
    <section>
        ...
        <div class="third_screen_login">
            <div class="card_cardScreen">
                ...
                <div class="card_clientDados">
                    ...
                    <form class="dados_cadastrais_usuario" action="indexusuario.php" method="post">
                        ...
                        <ul>
                            ...
                            <li class="confirm_alteracao"><button id="botao_confirm_alteracao" formaction="" ty="submit" name="confirmar">Confirmar</button></li>
                        </ul>
                    </form>
                </div>
        ...
        <div class="left_menu">
            <div class="left_links">
                <ul>
                    <li>
                        <a class="linkWhite" href="#">PRODUTOS</a>
                    </li>
                    <li>
                        <a class="linkBlack" href="#">PLANEJAR</a>
                    </li>
                </ul>
            </div>
