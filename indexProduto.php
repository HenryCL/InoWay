<?php
include_once('CadastraProdutoController.php');

$cadastroProduto = new CadastrarProdutoController();
if(isset($_POST['cadastrar'])){
    $cadastroProduto->CadastroProduto($_POST);
}
?>
<!DOCTYPE html>
<html lang="pt-BR">
...
<body>
        ...
        <div class="card_login">
            ...
            <div class="card_content">
                ...
                <form class="login" action="#">
                    ...
                    <div class="data">
                        <label>Senha</label>
                        <input class="login_imputBox" name="senhaInput" type="text" required>
                    </div>
                    <ul>
                        <li class="entrar"><button onclick="openPageUsuario()" type="submit">Entrar</button></li>
                ...
                <form class="cadastro" action="#">
                    ...
                    <div class="data_cadastro">
                        <label>E-mail</label>
                        <input class="cadastro_imputBox" name="senhaInput" type="text" required>
                    </div>
                    <div class="data_cadastro">
                        <label>Senha</label>
                        <input class="cadastro_imputBox" name="senhaInput" type="text" required>
                    ...
                    <ul>
                        <li class="cadastrar"><button type="submit">Cadastrar</button></li>
    ...
    <section>
        ...
        <div class="third_screen_login">
            <div class="card_cardScreen">
                ...
                <div class="card_clientDados">
                    ...
                    <form class="dados_cadastrais_usuario" action="#">
                        ...
                        <ul>
                            ...
                            <li class="confirm_alteracao"><button id="botao_confirm_alteracao" formaction="submite" type="submit" name="confirmar">Confirmar</button></li>
                        </ul>
                    </form>
                </div>
                <div class="card_content_conta">
                    ...
                    <div class="card_hitCompras">
                        <div class="tag_hitCompras"><img class="histComp" src="images/estoques.png" alt=""><label class="historicoNome">Histórico</label></div>
                        <div class="listagem">
                            <img src="images/empty.png" alt="empty">
                            <!--inserir php para coletar os itens adcionados no carrinho-->
                            <!--se seleção for vazia mostrar imagem de vazio-->
            ...
            <div class="card_cardScreen_adm">
                ...
                <div class="card_clientDados">
                    ...
                    <form class="dados_cadastrais_item" action="indexProduto.php" method="post">
                    <input type="hidden" name="cod_produto" id="cod_produto" value="<?php echo $cod_produto['cod_produto'] ?? ''?>">
                        ...
                        <div class="data_info_usuario">
                            ...
                            <select class="selection" name="classificacao">
                                <option value="select">Escolha uma opção</option>
                                <option value="nicho movel">Nicho Móvel</option>
                                <option value="nicho aereo">Nicho Aereo</option>
                            </select>
                        </div>
                            <div class="separacao">
                                <div class="data_info_usuario">
                        ...
                        <div class="separacao">
                            <div class="data_info_usuario">
                                <label>Altura</label>
                                <input id="preencher_it" class="info_item_input" name="altura_item" type="text" required readonly>
                            </div>
                            <div class="data_info_usuario">
                                <label>Largura</label>
                                <input id="preencher_it" class="info_item_input" name="largura_item" type="text" required readonly>
                            </div>
                        </div>
                        <div class="separacao">
                            <div class="data_info_usuario">
                                <label>Profund.</label>
                                <input id="preencher_it" class="info_item_input" name="profund_item" type="text" required readonly>
                            </div>
                            <div class="data_info_usuario">
                                <label>Espessura</label>
                                <input id="preencher_it" class="info_item_input" name="espessura_item" type="text" required readonly>
                            </div>
                        </div>
                        ...
                        <ul id="opcoes_cadastro_item_botao">
                            <li id="botao_cadastra_item" class="cadastrar_item"><button id="botao_cadastra_itens" name="cadastrar">Cadastrar</button></li>
        ...
        foreach ($listar as $produtos){
            echo '<tr><td>'.$produtos['cod_produto'].'</td>
            <td>'.$produtos['descricao'].'</td>
            <td><a href ="https://inoway.000webhostapp.com/DeletarProduto.php?cod_produto='.$produtos['cod_produto'].'" class="excluir">Excluir</a></td>
            <tr>';
        }
        ?>
        </table>
                    ...
                    <div class="card_hitCompras">
                        <div class="tag_hitVompras"><img class="histComp" src="images/estoques.png" alt=""><label class="historicoNome">Estoque</label></div>
                        <div class="listagem">
                            <img src="images/empty.png" alt="empty">
                            <!--inserir php para coletar os itens adcionados no carrinho-->
                            <!--se seleção for vazia mostrar imagem de vazio-->
        ...
        <div class="left_menu">
            <div class="left_links">
                <ul>
                    <li>
                        <a class="linkWhite" href="index.php">PRODUTOS</a>
                    </li>
                    <li>
            ...
            <div class="icon_usu"><img onclick="openPageUsuario()" class="icon_usuario" src="images/iconUsuario.png" alt=""></div>
        </div>
        <div class="main">
            <div class="box_items">
                <div class="item1"></div>
...
<?php
        $command_ = "SELECT COUNT(`cod_produto`) FROM `$produtos`";      
